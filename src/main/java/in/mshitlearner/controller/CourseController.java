...
import in.mshitlearner.dto.Course;
...
public class CourseController {
	    ...
	    @PutMapping(value = "/updateCourse/{id}", produces = "application/json", consumes = "application/json")
	    ...
	    @DeleteMapping(value = "/deleteCourse/{id}", produces = "application/json")
